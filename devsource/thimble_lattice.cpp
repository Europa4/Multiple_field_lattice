  ...
  for (int i = 0; i < number_of_timesteps; ++i)
  {
    ...
    for (int r = 0; r < Njac; ++r)
    {
      ...
      for (int c = 0; c < Njac; ++c)
      {
        ...
        for(int s = 0; s < Njac; ++s)
        {
          k2_jac[r + Njac*c] += h*std::conj(-1.*j*calc_ddS(r, s, ajustment)*Jac[s + Njac*c]);
        }
      }
    }
    ...
    for (int r = 0; r < Njac; ++r)
    {
      ...
      for (int c = 0; c < Njac; ++c)
      {
        ...
        for (int s = 0; s < Njac; ++s)
        {
          k3_jac[r + Njac*c] += h*std::conj(-1.*j*calc_ddS(r, s, ajustment)*Jac[s + Njac*c]);
        }
      }
    }
    ...
    for (int r = 0; r < Njac; ++r)
    {
      ...
      for (int c = 0; c < Njac; ++c)
      {
        ...
        for(int s = 0; s < Njac; ++s)
        {
          k4_jac[r + Njac*c] += h*std::conj(-1.*j*calc_ddS(r, s, ajustment)*Jac[s + Njac*c]);
        }
      }
    }
